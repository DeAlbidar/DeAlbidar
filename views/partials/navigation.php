        ...
        <nav id="sideNavs" class="mainmenu-nav navbar-example2 onepagenav">
            <ul class="primary-menu nav nav-pills">
                <li class="nav-item current">
                    <a class="nav-link smoth-animation-two" href="<?php echo URL.''; ?>#home">
                        <i data-feather="home"></i> Home
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link smoth-animation-two" href="<?php echo URL.''; ?>#features"> 
                        <i data-feather="briefcase"></i>Features
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link smoth-animation-two" href="<?php echo URL.'index#portfolio'; ?>">
                        <i data-feather="layers"></i>Portfolio
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link smoth-animation-two" href="<?php echo URL.'index#resume'; ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link smoth-animation-two" href="<?php echo URL.'index#pricing'; ?>">
                        <i data-feather="shopping-cart"></i>Pricing
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link smoth-animation-two" href="<?php echo URL.'index#blog'; ?>">
        ...
        <div class="footer">
            <div class="social-share-style-1">
                ...
                <ul class="social-share d-flex liststyle">
                    <li class="facebook">
                        <a href="https://facebook.com/DeAlbidar">
                    ...
                    <li class="instagram">
                        <a href="https://www.instagram.com/DeAlbidar/">
                    ...
                    <li class="linkedin">
                        <a href="https://www.linkedin.com/in/DeAlbidar">
                    ...
                    <li class="twitter">
                        <a href="https://twitter.com/DeAlbidar">
    ...
    <div class="inner">
        <div class="menu-top">
            <div class="menu-header">
                <a class="logo" href="<?php echo URL."index"; ?>">
                    <img src="<?php echo URL.'public/assets/images/logo/logos-circle.png'; ?>" alt="Personal Portfolio">
                </a>
        ...
        <div class="content">
            <ul class="primary-menu nav nav-pills onepagenav">
                <li class="nav-item current">
                    <a class="nav-link smoth-animation-two" href="<?php echo URL.'index#home'; ?>">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link smoth-animation-two" href="<?php echo URL.'index#features'; ?>">Features</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link smoth-animation-two" href="<?php echo URL.'index#portfolio'; ?>">Portfolio</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link smoth-animation-two" href="<?php echo URL.'index#pricing'; ?>">Pricing</a>
                </li>
                <li class="nav-item">
                ...
                <ul class="social-share d-flex liststyle">
                    ...
                    <li class="twitter">
                        <a href="https://twitter.com/DeAlbidar">
                            ...
                            <rect x="2" y="9" width="4" height="17"></rect>
                            <circle cx="4" cy="4" r="2"></circle>
                            </svg>
                        </a>
                    </li>

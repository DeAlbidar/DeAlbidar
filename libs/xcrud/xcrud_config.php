...
{
    // default connection
    public static $dbname = 'WatchGhana'; // Your database name
    public static $dbuser = 'sa'; // Your database username
    public static $dbpass = '1234'; // // Your database password
    ...
    // editor
    public static $editor_url = '/libs/xcrud/plugins/ckeditor/ckeditor.js'; // URL path to editor script, if you want to use the visual editor.
    ...
    public static $upload_folder_def = '../../public/files/'; // Default uploads folder on your site, relative to xCRUD folder or absolute path required. Folder is must exist.
    ...
    // alert settings
    public static $email_from = 'no-reply@watchghana.com'; // email from address
    public static $email_from_name = 'WatchGhana Publication'; // email from name
